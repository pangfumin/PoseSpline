#include "extern/transform_vector_error.hpp"
...
TransformVectorError::TransformVectorError(double t_meas,
        ...
        rotatedVector_Meas_(rotatedVector){
...
bool TransformVectorError::EvaluateWithMinimalJacobians(double const* const * parameters,
    ...
    Eigen::Vector3d t0(parameters[0][0], parameters[0][1], parameters[0][2]);
    Eigen::Vector3d t1(parameters[1][0], parameters[1][1], parameters[1][2]);
    Eigen::Vector3d t2(parameters[2][0], parameters[2][1], parameters[2][2]);
    Eigen::Vector3d t3(parameters[3][0], parameters[3][1], parameters[3][2]);
...
*/
    ...
    Eigen::Vector3d rotatedVector_hat = quatToRotMat<double>(Q_hat)*originalVector_ + t_hat;
    error =  rotatedVector_hat - rotatedVector_Meas_;
