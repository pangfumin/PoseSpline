...
struct SplineProjectFunctor{
    ...
    bool operator()(const T* const T0_param, const T* const T1_param,
        ...
        T correct_t0 = T(t0_) + bias_t[0];
        T correct_t1 = T(t1_) + bias_t[0];
        T  Beta01 = QSUtility::beta1(correct_t0);
        T  Beta02 = QSUtility::beta2(correct_t0);
        T  Beta03 = QSUtility::beta3(correct_t0);

        T  Beta11 = QSUtility::beta1(correct_t1);
