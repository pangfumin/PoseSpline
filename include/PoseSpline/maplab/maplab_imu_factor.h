...
class IntegrationBase{
    public:
        ...
        evaluate(const Eigen::Matrix<T,3,1> &Pi, const Eigen::Matrix<T,4,1> &Q_IiW,
            ...
            // std::cout << "maplab temp0: " << temp0.transpose() << std::endl; 
    ...
    public:
        ...
        bool EvaluateWithMinimalJacobians(double const *const *parameters,
            ...
            Eigen::Vector4d Q_IiW(parameters[0][3], parameters[0][4], parameters[0][5], parameters[0][6]);
            ...
            Eigen::Vector4d Q_IjW(parameters[2][3], parameters[2][4], parameters[2][5], parameters[2][6]);
            ...
            residual = pre_integration->evaluate(Pi, Q_IiW, Vi, Bai, Bgi,
                                                 Pj, Q_IjW, Vj, Baj, Bgj,
                                                 internal_jacobians);

            Eigen::Matrix<double, 15, 15> sqrt_info = Eigen::LLT<Eigen::Matrix<double, 15, 15>>(
                    pre_integration->covariance_.inverse()).matrixL().transpose();
            ...
            if (jacobians)
            {
                ...
                if (jacobians[0])
                {
                    ...
                    jacobian_pose_i << J_r_t_WI0, J_r_q_I0W;
                ...
                if (jacobians[2])
                {
                    ...
                    jacobian_pose_j << J_r_t_WI1, J_r_q_I1W;
