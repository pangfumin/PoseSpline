...
#ifndef SPLINE_PROJECT_FACTOR2_H
#define SPLINE_PROJECT_FACTOR2_H
#include <vector>
#include <mutex>
...
struct SplineProjectFunctor2{
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    SplineProjectFunctor2(const double _t0, const Eigen::Vector3d& uv_C0,
    ...
    bool operator()(const T* const T0_param, const T* const T1_param,
        ...
        QuaternionTemplate<T> r_11 = QSUtility::r(Beta11,phi3);
        QuaternionTemplate<T> r_12 = QSUtility::r(Beta12,phi4);
        QuaternionTemplate<T> r_13 = QSUtility::r(Beta13,phi5);
        ...
        QuaternionTemplate<T> Q_WI1_hat = quatLeftComp(Q2)*quatLeftComp(r_11)*quatLeftComp(r_12)*r_13;
        Eigen::Matrix<T,3,1> t_WI1_hat = t2 + Beta11*(t3 - t2) +  Beta12*(t4 - t3) + Beta13*(t5 - t4);
...
class SplineProjectError2{

public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    SplineProjectError2() = delete;
    SplineProjectError2(const SplineProjectFunctor2& functor);

    /// \brief Trivial destructor.
    virtual ~SplineProjectError2() {}
...
private:
    SplineProjectFunctor2 functor_;
};
