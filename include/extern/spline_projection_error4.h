...
#ifndef SPLINE_PROJECT_FACTOR4_H
#define SPLINE_PROJECT_FACTOR4_H
#include <vector>
#include <mutex>
...
struct SplineProjectFunctor4{
    ...
    SplineProjectFunctor4(const double _t0, const Eigen::Vector3d& uv_C0,
    ...
    bool operator()(const T* const T0_param, const T* const T1_param,
                    ...
                    const T* const T6_param, const T* const T7_param,
        ...
        QuaternionTemplate<T> Q7 = T7.rotation();
        ...
        Eigen::Matrix<T,3,1> t7 = T7.translation();
        ...
        Eigen::Matrix<T,3,1> phi7 = QSUtility::Phi<T>(Q6,Q7);
        ...
        QuaternionTemplate<T> r_11 = QSUtility::r(Beta11,phi5);
        QuaternionTemplate<T> r_12 = QSUtility::r(Beta12,phi6);
        QuaternionTemplate<T> r_13 = QSUtility::r(Beta13,phi7);
        ...
        QuaternionTemplate<T> Q_WI1_hat = quatLeftComp(Q4)*quatLeftComp(r_11)*quatLeftComp(r_12)*r_13;
        Eigen::Matrix<T,3,1> t_WI1_hat = t4 + Beta11*(t5 - t4) +  Beta12*(t6 - t5) + Beta13*(t7 - t6);
...
class SplineProjectError4{

public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    SplineProjectError4() = delete;
    SplineProjectError4(const SplineProjectFunctor4& functor);

    /// \brief Trivial destructor.
    virtual ~SplineProjectError4() {}
...
private:
    SplineProjectFunctor4 functor_;
};
