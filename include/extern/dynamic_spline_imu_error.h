...
//            std::cout << "** Bgj: " << Bgj.transpose() << std::endl;
        ...
        bool operator()(T const* const* parameters,
            ...
            Pose<T> T0(parameters[0]);
            Pose<T> T1(parameters[1]);
            Pose<T> T2(parameters[2]);
            Pose<T> T3(parameters[3]);


            Eigen::Map<const Eigen::Matrix<T,6,1>> b0(parameters[4]);
            Eigen::Map<const Eigen::Matrix<T,6,1>> b1(parameters[5]);
            Eigen::Map<const Eigen::Matrix<T,6,1>> b2(parameters[6]);
            Eigen::Map<const Eigen::Matrix<T,6,1>> b3(parameters[7]);
...
//            std::cout << "U: " << t0_ << " " << Beta01 << " " << Beta02 << " " << Beta03 << std::endl;
            ...
            Eigen::Matrix<T,3,1> Pi = t0 + Beta01*(t1 - t0) +  Beta02*(t2 - t1) + Beta03*(t3 - t2);
//            std::cout << "V0: " << t0.transpose() << std::endl;
//            std::cout << "V1: " << (t1 - t0).transpose() << std::endl;
//            std::cout << "V2: " << (t2 - t1).transpose() << std::endl;
//            std::cout << "V3: " << (t3 - t2).transpose() << std::endl;
